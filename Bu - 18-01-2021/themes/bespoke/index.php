...
<main id="Home">
        ...
        <div class="row">
            <div class="col banner-col banner-left">
                <div class="banner-docs">
                    ...
                    <div class="Badge">
                        <div class="Badge-img">
                            <img data-src="<?php echo V_CDN_URL.V_THEME_DIR;?>assets/images/banner/Badge.png" alt="Badge" title="Badge" class="lazy">
                        </div>
            ...
            <div class="col banner-col banner-right">
                <div class="banner-docs">
                    <a href="<?php echo _isset($home_content,'risk_profiling_services_link');?>" class="btn btn-bg btn-radius"> <?php echo _isset($home_content,'risk_profiling_services_title');?> </a>
                </div>
            </div>
        </div>
    </Section>
    ...
    <!-- Brand End -->
    <!-- Problem Start -->
    <section class="Problem bg-color-Smoky-Black" style="background-image:url('<?php echo V_CDN_URL.$home_content['problem_background_image'][0]['urlPath'];?>');">
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <div class="Problem-qna-box">
                        <div class="text-Grey-white-bg bg-color-White Problem-qna fw-400">
                            <h4 class="text-Dark-Grey fw-600">
                                <?php echo _isset($home_content,'overwhelming_range_title');?>
                            </h4>
                            <?php echo _isset($home_content,'overwhelming_range_content');?>
                        </div>
                        <div class="text-Grey-white-bg bg-color-White Problem-qna fw-400">
                            <h4 class="text-Dark-Grey fw-600">
                                <?php echo _isset($home_content,'finding_the_best_title');?>
                            </h4>
    ...
    <!-- Problem End -->
    <!-- Solution Start -->
    <section class="Solution bg-no-repeat solution-section" style="background-image:url('<?php echo V_CDN_URL.$home_content['the_solution_background_image'][0]['urlPath'];?>'),linear-gradient(180deg, #0e0f0f 0%, #009182 100%);">
        <div class="container">
            ...
            <div class="row row-reverse">
                ...
                <div class="col">
                    <div class="discover-docs ">
                        ...
                        <div class="btn-Group">
                            <a href="<?php echo _isset($home_content,'learn_more_link');?>" class="btn btn-bg"><?php echo _isset($home_content,'learn_more_title');?></a>
                            <a href="<?php echo _isset($home_content,'get_online_quote_link');?>" class="btn btn-border"><?php echo _isset($home_content,'get_online_quote_title');?></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="Comment-top_Badge">
                    ...
                    <div class="Comment-top_Badge-info">
                        ...
                        <hr class="text-White">
                        <p class="fw-500 text-Light-Green-text-green-bg "><?php echo _isset($home_content,'over_15_industry_small_content');?></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="Comment-row">
                    <div class="Comment-bottom-left  bg-no-repeat"
                        ...
                        <div class="Comment-left-docs">
                            <div class="">
                                <img data-src="<?php echo V_CDN_URL.V_THEME_DIR;?>assets/images/Comment/st.png" alt="st" title="st" class="lazy">
                            </div>
                            <h2 class="text-White">
                    ...
                    <div class="Comment-bottom-right  bg-color-Light-Teal">
                        <div class="Comment-bottom-docs">
                            <div class="">
                                <img data-src="<?php echo V_CDN_URL.V_THEME_DIR;?>assets/images/Comment/sb.png" alt="sb" title="sb" class="lazy">
                            </div>
            ...
            <div class="Service-filter">
                ...
                <div class="Service-filter-ditel">
                    <div class="Service-filter-itme itme-1" style="display: block;">
                        <img data-src="<?php echo V_CDN_URL.V_THEME_DIR;?>assets/images/Service/service-image-1.png" class="lazy service-image">
