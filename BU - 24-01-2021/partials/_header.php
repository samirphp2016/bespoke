<?php
	...
	$access_to_over_100_australian_insurersArr = array();
    $access_to_over_100_australian_insurers = access_to_over_100_australian_insurers::get_data($access_to_over_100_australian_insurersArr);		
    if(count($access_to_over_100_australian_insurers)){
        $access_to_over_100_australian_insurers = $access_to_over_100_australian_insurers[0];
    ...
    <header class="site-header">
        <div class="wrapper site-header__wrapper">
            ...
            <a href="#" class="btn btn-border">
                <img data-src="<?php echo V_CDN_URL.V_THEME_DIR;?>assets/images/call.png" alt="call" title="call" class="lazy">
                    
                </a>
                <a href="#" class="btn btn-bg">
                <img data-src="<?php echo V_CDN_URL.V_THEME_DIR;?>assets/images/sms.png" alt="sms" title="sms" class="lazy">
